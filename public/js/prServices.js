 ...
 **/
/* global PosRep, viewer, Cesium, angular, io,  X2JS, LZString, Saxon */
// ***** SERVER SERVICES ******//
/** 
 * @param  $indexedDB
 * @param  $http
 */
PosRep.factory('DbService', function($indexedDB, $http) {
    var dbsvc = {};
    dbsvc.xj = new X2JS();
    dbsvc.dB = $indexedDB;
    dbsvc.map = [];
...
PosRep.factory('GeoService', function($indexedDB) {
    var geosvc = {};
    geosvc.dB = $indexedDB;
    geosvc.mapid = null;
    geosvc.sdatasources = [];
...
PosRep.factory('MsgService', function($indexedDB, $http) {
    var msgsvc = {};
    //msgsvc.xj = new X2JS();
...
PosRep.factory('SocketService', function() {
    var scktsvc = {};
    scktsvc.serverid;
    scktsvc.mapid;
    scktsvc.namespace;
...
PosRep.factory('XSLService', function() {
    var xslsvce = {};
...
PosRep.factory('DlgBx', function($mdDialog) {
    var dlg = {};
    dlg.alert = function(t, m, lbl) {
        $mdDialog.show(
            $mdDialog.alert()
            .title(t)
            .textContent(m)
